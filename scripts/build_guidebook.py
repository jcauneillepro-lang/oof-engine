...
<style>
  ...
  * {{ box-sizing: border-box; margin: 0; padding: 0; }}
  ...
  .comp-card header {{
    ...
    padding: 10px 14px; border-bottom: 1px solid var(--rule-thin);
    background: var(--paper-2); flex-shrink: 0;
  }}
  .comp-card .comp-num {{
    font-family: var(--mono); font-weight: 600; font-size: 9pt;
  ...
  /* Demo container: fixed 16:9 with scaled inner content */
  .comp-demo-wrap {{
  ...
  /* Drop the inline description — too noisy in dense grid */
  .comp-card .comp-desc {{ display: none; }}
